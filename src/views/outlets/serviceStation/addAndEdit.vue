 ...
 * @LastEditTime: 2020-06-29 14:08:49
...
<template>
  <div class="box">
    ...
    <div class="condition-box">
      <div class="content-title" v-if="!isEdit">新增服务站</div>
      <div class="content-title" v-if="isEdit">编辑服务站</div>
...
import { getServiceById, serviceSave, serviceUpdate, areaDict, cityList } from "@/api/outlet.js";
