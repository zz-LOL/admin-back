 ...
 * @LastEditTime: 2020-06-29 14:12:16
 * @Description: 换电站详情
--> 
...
<template>
  <div class="goods-contanier">
    <div class="big-title">
      <div class="title-o">换电站详情</div>
      <div class="title-t">查看换电站的详细信息，包括基础门店信息和补充信息</div>
    </div>
    
    <!-- 基本信息 -->
    <div class="base-info">
      <div class="title">换电站基础信息</div>
...
<script>
import { getChargingById } from "@/api/outlet.js";
